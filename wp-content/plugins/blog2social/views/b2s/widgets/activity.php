...
<div id="chart_div" data-text-scheduled="<?php _e('scheduled social media posts', 'blog2social'); ?>" data-text-published="<?php _e('published social media posts', 'blog2social'); ?>" data-language='<?php echo (substr(B2S_LANGUAGE, 0, 2) == 'de' ? 'de' : 'en'); ?>'>
