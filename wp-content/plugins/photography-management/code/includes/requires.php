...
;
require_once
  (plugin_dir_path(dirname(__FILE__))."protect_images/protect.php")
;
...
require_once
  (plugin_dir_path(dirname(__FILE__))."includes/superglobals.php")
;
...
;
require_once
  (plugin_dir_path(dirname(__FILE__))."admin/frontendHandler.php")
;
