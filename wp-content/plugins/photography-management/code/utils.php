...
namespace codeneric\phmm {
  ...
  class Utils {
    ...
    static function apply_filter_or($filterHandle, $arg, $or) {
    ...
    static function array_nested_key_exist($path, $array, $separator = ".") {
    ...
    static function get_temp_file($prefix) {
    ...
    static function get_post_meta_ONLY_USE_IN_HELPER_FUNCTIONS($postID, $key) {
    ...
    static function array_reduce($array, $f, $init) {
      $temp = $init;
      $res = array();
    ...
    static function get_admin_notice_transient_key($id) {
    ...
    static function add_admin_notice(
      ...
      $currently_cooling_down = \get_transient($transient);
