...
function lens_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'lens_custom_header_args', array(
		'default-image'          => get_template_directory_uri().'/assets/images/HB_Masthead_Background_Logo_Black_Smaller.jpg',
	...
	register_default_headers( array(
			'default-image'    => array(
				'url'            => '%s/assets/images/HB_Masthead_Background_Logo_Black_Smaller.jpg',
				'thumbnail_url'    => '%s/assets/images/HB_Masthead_Background_Logo_Black_Smaller.jpg',
