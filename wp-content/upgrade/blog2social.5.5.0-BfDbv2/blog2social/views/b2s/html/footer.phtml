                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php _e('Insert white frames to show the whole image in your timeline. All image information will be shown in your timeline.', 'blog2social'); ?>
                            </div>
                            <div class="col-md-6">
                                <br>
                                <b>2) <?php _e('Image cut out', 'blog2social') ?></b><br>
                                <?php _e('The image preview will be cropped automatically to fit the default Instagram layout for your Instagram timeline. The image will be shown uncropped when opening the preview page for your Instagram post.', 'blog2social'); ?>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?php _e('Did you miss something?', 'blog2social') ?></h4>
                </div>
                <div class="modal-body">
                    <?php _e('Help us make Blog2Social even better!', 'blog2social') ?>
                    <textarea id="b2s-trial_message" class="form-control"></textarea>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary b2s-send-trail-feedback"><?php _e('submit', 'blog2social') ?></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <div class="meta-title modal-meta-content" data-meta-origin="settings" style="display: none;">
                        <?php _e('Social Meta Tags Settings', 'blog2social') ?>
                    </div>
            ...
            <div class="modal-body">
                ...
                <div class="meta-body modal-meta-content" data-meta-type="og" data-meta-origin="ship" style="display: none;">
                    <?php _e('You can change the image, title and description for your post on Facebook, by editing the following fields for', 'blog2social') ?>
                    <br>
                    <br>
                    <b>- <?php _e('image', 'blog2social') ?></b><br>
                    <b>- <?php _e('title', 'blog2social') ?></b><br>
                    <b>- <?php _e('description', 'blog2social') ?></b><br>
                    <br>
                    <?php _e('Blog2Social will automatically write these information in the Facebook Open Graph (OG) Meta Tags for Image, Title and Description of your blog post.', 'blog2social') ?>
                    <br>
                    <br>
                    <?php _e('Please note: If this post has already been shared or scheduled previously, your current changes will also affect the look of previously shared or scheduled posts, as Facebook always refers to the current Open Graph meta tags information and automatically updated all existing posts.', 'blog2social') ?><br>
                    <br>
                ...
                <div class="meta-body modal-meta-content" data-meta-type="card" data-meta-origin="ship" style="display: none;">
                    <?php _e('You can change the image, title and description for your post on Twitter, by editing the following fields for', 'blog2social') ?>
                    <br>
                    <br>
                    <b>- <?php _e('image', 'blog2social') ?></b><br>
                    <b>- <?php _e('title', 'blog2social') ?></b><br>
                    <b>- <?php _e('description', 'blog2social') ?></b><br>
                    <br>
                    <?php _e('Blog2Social will automatically write these information in the Twitter Card Meta Tags for Image, Title and Description of your blog post.', 'blog2social') ?>
                    <br>
                    <br>
                    <?php _e('Please note: If this post has already been shared or scheduled previously, your current changes will also affect the look of previously shared or scheduled posts, as Twitter always refers to the current Twitter Card information. However, if you have already shared this post, Twitter may update your current changes within 7 days.', 'blog2social') ?><br>
                    <br>
                ...
                <?php if (B2S_PLUGIN_USER_VERSION == 0) {
                    ...
                    <br>
                    <hr>               
                    <h4><?php _e('You want to change the image, title and description for your post?', 'blog2social'); ?></h4>
                    <?php _e('With Blog2Social Premium you can:', 'blog2social') ?>
                    <br>
                    <br>
                    <span class="glyphicon glyphicon-ok glyphicon-success"></span> <?php _e('Post on pages and groups', 'blog2social') ?><br>
